    ...
    return LaunchDescription([
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69ee7500f25c6f3e7bc9e6ce","mode":"speed","max_speed":360,"timeout_s":0}')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69ee758cf25c6f3e7bc9f1b6","mode":"speed","max_speed":360,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3cd62b3f393789aad70a2:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69ee74f9f25c6f3e7bc9e5c6","mode":"speed","max_speed":360,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3cd62b3f393789aad70a2:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69ee7913df065b5cb52a51d1","mode":"speed","max_speed":360,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3cd62b3f393789aad70a2:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
